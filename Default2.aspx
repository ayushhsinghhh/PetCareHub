...
<body class="auto-style2">
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" Height="1474px" CssClass="auto-style3">
            ...
            <asp:Button ID="Button1" runat="server" Text="Pet Store" BackColor="White" BorderStyle="None" Font-Bold="False" Font-Names="Georgia" Font-Size="Medium" />
            ...
            <asp:Image ID="Image3" runat="server" ImageUrl="~/istockphoto-141788254w4-170667a.jpg" />
            <asp:Image ID="Image4" runat="server" ImageUrl="~/pets-3715733_640.jpg" />
